  ...
  const zero = BigNumber.from("0");
    ...
    <div className="container">
        ...
        <div className="product-form">
                <form>
                    <div >
                        <input className="input-area" type="text" id="product-name" placeholder="Enter image Url"></input>
                    </div>
                    <div>
                        <input  className="input-area" type="text" id="product-name" placeholder="Enter Product Name"></input>
                    </div>

                    <div>
                        <input className="input-area" type="text" id="product-category" placeholder="Enter Category(electronics,nft,household)"></input>
                    </div>
                    ...
                    <div>
                        <input className="input-area" type="text" id="product-category" placeholder="Quantity"></input>
                    </div>
                    ...
                    <div className="price-selection">
                        ...
                        <select name="myCar" id="token">
                            <option value="indica" >Eth</option>
                            <option value="swift" selected>USDC</option>
                            <option value="indica" > polygon
                                </option>
                            <option value="indica" >File Coin</option>
                        </select>
                    </div>
                    </div>
